...
4. **Build.** The toolkit works out which files you changed and packs them back into whichever target you ask for: just the changed game files (`tpmt build patch`), or a playable ISO (`tpmt build image`).
